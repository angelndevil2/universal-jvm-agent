...
public class MBean {
    ...
    public Response getAttribute(
                                 ...
                                 @PathParam("name") String name) throws MalformedObjectNameException, AttributeNotFoundException, MBeanException, ReflectionException, InstanceNotFoundException {
